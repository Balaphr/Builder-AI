...
export const WEBSITE_TYPES: WebsiteType[] = [
  {
    ...
    defaultTemplate: 'tpl-agency',
    color: '#6366f1',
  },
  {
    id: 'news',
    name: 'News',
    description: 'News website with articles and categories',
    icon: 'Newspaper',
    modules: ['auth', 'news', 'blog', 'comments', 'analytics'],
    defaultTemplate: 'tpl-blog',
    color: '#ef4444',
  },
  {
    id: 'marketplace',
    name: 'Marketplace',
    description: 'Online marketplace with products and sellers',
    icon: 'ShoppingCart',
    modules: ['auth', 'profiles', 'products', 'cart', 'orders', 'sellers', 'reviews', 'payments', 'analytics'],
    defaultTemplate: 'tpl-ecommerce',
    color: '#10b981',
  },
  {
    id: 'services',
    name: 'Services',
    description: 'Service marketplace with bookings',
    icon: 'Tools',
    modules: ['auth', 'profiles', 'services', 'bookings', 'reviews', 'payments', 'analytics'],
    defaultTemplate: 'tpl-agency',
    color: '#3b82f6',
  },
  {
  ...
  },
  {
    ...
    defaultTemplate: 'tpl-realestate',
    color: '#f59e0b',
  },
  {
    id: 'food',
    ...
    defaultTemplate: 'tpl-restaurant',
    color: '#f97316',
  },
  {
    id: 'grocery',
    name: 'Grocery',
    description: 'Grocery delivery and subscription platform',
    icon: 'ShoppingBasket',
  ...
  },
  {
    id: 'ai-tools',
    name: 'AI Tools',
    description: 'AI tool directory and marketplace',
    icon: 'Brain',
    modules: ['auth', 'tools', 'billing', 'subscriptions', 'ratings', 'analytics'],
    defaultTemplate: 'tpl-saas',
    color: '#8b5cf6',
  },
  {
    id: 'drive',
    ...
    defaultTemplate: 'tpl-personal',
    color: '#06b6d4',
  },
  {
    id: 'blog',
    name: 'Blog',
    description: 'Content blog with articles and newsletter',
    icon: 'PenTool',
  ...
  },
  {
    ...
    defaultTemplate: 'tpl-portfolio',
    color: '#14b8a8',
  },
  {
    id: 'landing',
    name: 'Landing Page',
    description: 'Single-page landing for marketing',
    icon: 'MousePointer',
    modules: ['analytics'],
    defaultTemplate: 'tpl-landing',
    color: '#6366f1',
  },
  {
    id: 'saas',
    name: 'SaaS',
    description: 'Software-as-a-service product site',
    icon: 'Rocket',
  ...
  },
  {
    id: 'custom',
    name: 'Custom',
    description: 'Build from scratch with custom modules',
    icon: 'Settings',
    modules: [],
